...
Responsibilities:
- Evaluate the quality of outputs and decisions.
- Identify weaknesses, blind spots, or possible errors.
- Provide actionable feedback for improvements.

Rules:
- Return JSON with {feedback: str, severity: str}.
- No extra commentary outside the structured output.
""",
)

class Critic(RoutedAgent):
    def __init__(self):
        super().__init__("Critic")
        self.assistant = critic_assistant
